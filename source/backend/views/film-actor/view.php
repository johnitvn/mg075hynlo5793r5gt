...
<div class="giiant-crud film-actor-view">
    ...
    <?php $this->beginBlock('backend\models\FilmActor'); ?>
    ...
    'content' => $this->blocks['backend\models\FilmActor'],
    'active'  => true,
], ]
                 ]
    );
