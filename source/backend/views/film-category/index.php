...
/* @var $searchModel backend\models\search\FilmCategorySearch */
        ...
        <div class="panel-body"> 
            <form>
                <div class="input-group">
                    <input type="text" placeholder="<?=Yii::t('app', 'Search film-category')?>" class="input form-control" name="q" value="">
