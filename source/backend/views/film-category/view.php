...
<div class="giiant-crud film-category-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . Yii::t('app', 'List FilmCategories'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    ...
    <?php $this->beginBlock('backend\models\FilmCategory'); ?>
    ...
    'content' => $this->blocks['backend\models\FilmCategory'],
    'active'  => true,
], ]
                 ]
    );
